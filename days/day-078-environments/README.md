# Day 078: Environments

## Goal

Understand **Environments** and complete this practical task: **Model dev, staging, and production overlays**

Your evidence for today is: **Environment layout**

## Research Questions

- What problem does Environments solve?
...
2. Complete today's task: **Model dev, staging, and production overlays**
3. Add your **Environment layout** to this folder, or link to it under Artifact / Evidence.
...
Continue with [Day 079: Policy and scanning](../day-079-policy-and-scanning/README.md).
