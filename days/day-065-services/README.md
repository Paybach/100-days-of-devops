...
Understand **Services** and complete this practical task: **Expose a deployment inside the cluster**

Your evidence for today is: **Service manifest**

## Research Questions

- What problem does Services solve?
...
2. Complete today's task: **Expose a deployment inside the cluster**
3. Add your **Service manifest** to this folder, or link to it under Artifact / Evidence.
...
- [ ] I marked Day 065 complete in [PROGRESS.md](../../PROGRESS.md).
...
Continue with [Day 066: Configuration](../day-066-configuration/README.md).
