...
Understand **Logging** and complete this practical task: **Collect and search structured application logs**

Your evidence for today is: **Logging notes**
...
2. Complete today's task: **Collect and search structured application logs**
3. Add your **Logging notes** to this folder, or link to it under Artifact / Evidence.
...
Continue with [Day 083: Metrics](../day-083-metrics/README.md).
