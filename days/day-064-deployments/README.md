...
Understand **Deployments** and complete this practical task: **Create, scale, and update a deployment**

Your evidence for today is: **Deployment manifest**

## Research Questions

- What problem does Deployments solve?
...
2. Complete today's task: **Create, scale, and update a deployment**
3. Add your **Deployment manifest** to this folder, or link to it under Artifact / Evidence.
...
Continue with [Day 065: Services](../day-065-services/README.md).
