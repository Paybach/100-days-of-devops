# Day 032: GitHub Actions

## Goal

Understand **GitHub Actions** and complete this practical task: **Run a first workflow on push**

Your evidence for today is: **Workflow file**
...
2. Complete today's task: **Run a first workflow on push**
3. Add your **Workflow file** to this folder, or link to it under Artifact / Evidence.
...
Continue with [Day 033: Automated quality checks](../day-033-automated-quality-checks/README.md).
