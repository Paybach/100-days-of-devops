# Day 045: Terraform lifecycle

## Goal

Understand **Terraform lifecycle** and complete this practical task: **Run `init`, `plan`, `apply`, and `destroy` locally**

Your evidence for today is: **Lifecycle notes**

## Research Questions

- What problem does Terraform lifecycle solve?
...
2. Complete today's task: **Run `init`, `plan`, `apply`, and `destroy` locally**
3. Add your **Lifecycle notes** to this folder, or link to it under Artifact / Evidence.
...
Continue with [Day 046: Variables and outputs](../day-046-variables-and-outputs/README.md).
