# Day 040: Delivery capstone

## Goal

Understand **Delivery capstone** and complete this practical task: **Build a CI/CD workflow for the demo app**

Your evidence for today is: **Working pipeline**

## Research Questions

- What problem does Delivery capstone solve?
...
2. Complete today's task: **Build a CI/CD workflow for the demo app**
3. Add your **Working pipeline** to this folder, or link to it under Artifact / Evidence.
...
Continue with [Day 041: Cloud fundamentals](../day-041-cloud-fundamentals/README.md).
