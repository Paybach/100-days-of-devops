# Day 029: Container security

## Goal

Understand **Container security** and complete this practical task: **Run as non-root and scan an image**

Your evidence for today is: **Security findings**
...
2. Complete today's task: **Run as non-root and scan an image**
3. Add your **Security findings** to this folder, or link to it under Artifact / Evidence.
...
Continue with [Day 030: Container capstone](../day-030-container-capstone/README.md).
