...
Understand **Storage** and complete this practical task: **Attach persistent storage to a workload**

Your evidence for today is: **Storage manifests**
...
2. Complete today's task: **Attach persistent storage to a workload**
3. Add your **Storage manifests** to this folder, or link to it under Artifact / Evidence.
...
Continue with [Day 073: Helm](../day-073-helm/README.md).
