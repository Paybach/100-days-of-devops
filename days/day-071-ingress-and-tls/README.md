# Day 071: Ingress and TLS

## Goal

Understand **Ingress and TLS** and complete this practical task: **Route traffic through an ingress**

Your evidence for today is: **Ingress manifest**

## Research Questions

- What problem does Ingress and TLS solve?
...
2. Complete today's task: **Route traffic through an ingress**
3. Add your **Ingress manifest** to this folder, or link to it under Artifact / Evidence.
...
Continue with [Day 072: Storage](../day-072-storage/README.md).
