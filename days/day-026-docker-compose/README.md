# Day 026: Docker Compose

## Goal

Understand **Docker Compose** and complete this practical task: **Run an app and database together**

Your evidence for today is: **Compose file**
...
2. Complete today's task: **Run an app and database together**
3. Add your **Compose file** to this folder, or link to it under Artifact / Evidence.
...
- [ ] I marked Day 026 complete in [PROGRESS.md](../../PROGRESS.md).
...
Continue with [Day 027: Health checks](../day-027-health-checks/README.md).
