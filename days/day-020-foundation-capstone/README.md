# Day 020: Foundation capstone

## Goal

Understand **Foundation capstone** and complete this practical task: **Automate a basic Linux workstation or VM bootstrap**

Your evidence for today is: **Bootstrap project**

## Research Questions

- What problem does Foundation capstone solve?
...
2. Complete today's task: **Automate a basic Linux workstation or VM bootstrap**
3. Add your **Bootstrap project** to this folder, or link to it under Artifact / Evidence.
...
Continue with [Day 021: Docker concepts](../day-021-docker-concepts/README.md).
