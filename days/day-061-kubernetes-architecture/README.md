# Day 061: Kubernetes architecture

## Goal

Understand **Kubernetes architecture** and complete this practical task: **Explain control-plane and worker components**

Your evidence for today is: **Architecture notes**
...
2. Complete today's task: **Explain control-plane and worker components**
3. Add your **Architecture notes** to this folder, or link to it under Artifact / Evidence.
...
Continue with [Day 062: Local cluster](../day-062-local-cluster/README.md).
