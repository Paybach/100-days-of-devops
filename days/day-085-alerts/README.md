...
Understand **Alerts** and complete this practical task: **Design actionable alerts and avoid noisy ones**

Your evidence for today is: **Alert rules**

## Research Questions

- What problem does Alerts solve?
...
2. Complete today's task: **Design actionable alerts and avoid noisy ones**
3. Add your **Alert rules** to this folder, or link to it under Artifact / Evidence.
...
Continue with [Day 086: Tracing](../day-086-tracing/README.md).
