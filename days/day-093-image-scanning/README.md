# Day 093: Image scanning

## Goal

Understand **Image scanning** and complete this practical task: **Scan a container image and fix one issue**

Your evidence for today is: **Updated image**

## Research Questions

- What problem does Image scanning solve?
...
2. Complete today's task: **Scan a container image and fix one issue**
3. Add your **Updated image** to this folder, or link to it under Artifact / Evidence.
...
- [ ] I marked Day 093 complete in [PROGRESS.md](../../PROGRESS.md).
...
Continue with [Day 094: Secret scanning](../day-094-secret-scanning/README.md).
