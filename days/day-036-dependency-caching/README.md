# Day 036: Dependency caching

## Goal

Understand **Dependency caching** and complete this practical task: **Cache dependencies and compare runtimes**

Your evidence for today is: **Timing notes**

## Research Questions

- What problem does Dependency caching solve?
...
- Related milestone: [Container delivery project](../../projects/project-02-container-delivery/README.md)
...
2. Complete today's task: **Cache dependencies and compare runtimes**
3. Add your **Timing notes** to this folder, or link to it under Artifact / Evidence.
...
- [ ] I marked Day 036 complete in [PROGRESS.md](../../PROGRESS.md).
...
Continue with [Day 037: Releases](../day-037-releases/README.md).
