# Day 016: GitHub workflow

## Goal

Understand **GitHub workflow** and complete this practical task: **Create an issue, branch, and pull request**

Your evidence for today is: **Linked issue and PR**

## Research Questions

- What problem does GitHub workflow solve?
...
2. Complete today's task: **Create an issue, branch, and pull request**
3. Add your **Linked issue and PR** to this folder, or link to it under Artifact / Evidence.
...
Continue with [Day 017: YAML and JSON](../day-017-yaml-and-json/README.md).
