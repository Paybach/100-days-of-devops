# Day 046: Variables and outputs

## Goal

Understand **Variables and outputs** and complete this practical task: **Parameterize a Terraform configuration**

Your evidence for today is: **Updated config**

## Research Questions

- What problem does Variables and outputs solve?
...
2. Complete today's task: **Parameterize a Terraform configuration**
3. Add your **Updated config** to this folder, or link to it under Artifact / Evidence.
...
Continue with [Day 047: State](../day-047-state/README.md).
