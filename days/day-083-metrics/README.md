...
Understand **Metrics** and complete this practical task: **Expose and inspect useful application metrics**

Your evidence for today is: **Metrics list**

## Research Questions

- What problem does Metrics solve?
...
2. Complete today's task: **Expose and inspect useful application metrics**
3. Add your **Metrics list** to this folder, or link to it under Artifact / Evidence.
...
- [ ] I marked Day 083 complete in [PROGRESS.md](../../PROGRESS.md).
...
Continue with [Day 084: Dashboards](../day-084-dashboards/README.md).
