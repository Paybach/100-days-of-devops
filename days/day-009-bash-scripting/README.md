# Day 009: Bash scripting

## Goal

Understand **Bash scripting** and complete this practical task: **Write a timestamped backup script**

Your evidence for today is: **Backup script**
...
2. Complete today's task: **Write a timestamped backup script**
3. Add your **Backup script** to this folder, or link to it under Artifact / Evidence.
...
Continue with [Day 010: Health checks](../day-010-health-checks/README.md).
