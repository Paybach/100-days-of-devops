...
Understand **Dashboards** and complete this practical task: **Build a simple service dashboard**

Your evidence for today is: **Dashboard screenshot**

## Research Questions

- What problem does Dashboards solve?
...
2. Complete today's task: **Build a simple service dashboard**
3. Add your **Dashboard screenshot** to this folder, or link to it under Artifact / Evidence.
...
Continue with [Day 085: Alerts](../day-085-alerts/README.md).
