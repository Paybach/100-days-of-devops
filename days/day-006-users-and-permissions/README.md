# Day 006: Users and permissions

## Goal

Understand **Users and permissions** and complete this practical task: **Practice users, groups, `chmod`, and `chown`**

Your evidence for today is: **Permissions lab**

## Research Questions

- What problem does Users and permissions solve?
...
2. Complete today's task: **Practice users, groups, `chmod`, and `chown`**
3. Add your **Permissions lab** to this folder, or link to it under Artifact / Evidence.
...
Continue with [Day 007: Processes and services](../day-007-processes-and-services/README.md).
