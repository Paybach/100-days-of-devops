...
Understand **Argo CD** and complete this practical task: **Explore an Argo CD application manifest**

Your evidence for today is: **Application manifest**
...
2. Complete today's task: **Explore an Argo CD application manifest**
3. Add your **Application manifest** to this folder, or link to it under Artifact / Evidence.
...
- [ ] I marked Day 077 complete in [PROGRESS.md](../../PROGRESS.md).
...
Continue with [Day 078: Environments](../day-078-environments/README.md).
