# Day 002: SDLC and delivery flow

## Goal

Understand **SDLC and delivery flow** and complete this practical task: **Compare waterfall, agile, and continuous delivery**

Your evidence for today is: **Short comparison**

## Research Questions

- What problem does SDLC and delivery flow solve?
...
- Related milestone: [Foundation toolkit project](../../projects/project-01-foundation-toolkit/README.md)
...
2. Complete today's task: **Compare waterfall, agile, and continuous delivery**
3. Add your **Short comparison** to this folder, or link to it under Artifact / Evidence.
...
- [ ] I marked Day 002 complete in [PROGRESS.md](../../PROGRESS.md).
...
Continue with [Day 003: Workstation setup](../day-003-workstation-setup/README.md).
