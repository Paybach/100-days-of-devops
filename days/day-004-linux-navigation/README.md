# Day 004: Linux navigation

## Goal

Understand **Linux navigation** and complete this practical task: **Practice `pwd`, `ls`, `cd`, `mkdir`, and `find`**

Your evidence for today is: **Command notes**

## Research Questions

- What problem does Linux navigation solve?
...
2. Complete today's task: **Practice `pwd`, `ls`, `cd`, `mkdir`, and `find`**
3. Add your **Command notes** to this folder, or link to it under Artifact / Evidence.
...
Continue with [Day 005: Files and text](../day-005-files-and-text/README.md).
