# Day 003: Workstation setup

## Goal

Understand **Workstation setup** and complete this practical task: **Install Git, Docker, and an editor; record versions**

Your evidence for today is: **Setup checklist**

## Research Questions

- What problem does Workstation setup solve?
...
2. Complete today's task: **Install Git, Docker, and an editor; record versions**
3. Add your **Setup checklist** to this folder, or link to it under Artifact / Evidence.
...
- [ ] I marked Day 003 complete in [PROGRESS.md](../../PROGRESS.md).
...
Continue with [Day 004: Linux navigation](../day-004-linux-navigation/README.md).
