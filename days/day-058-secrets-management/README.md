# Day 058: Secrets management

## Goal

Understand **Secrets management** and complete this practical task: **Store and retrieve a secret securely**

Your evidence for today is: **Secrets workflow**
...
2. Complete today's task: **Store and retrieve a secret securely**
3. Add your **Secrets workflow** to this folder, or link to it under Artifact / Evidence.
...
- [ ] I marked Day 058 complete in [PROGRESS.md](../../PROGRESS.md).
...
Continue with [Day 059: Cost controls](../day-059-cost-controls/README.md).
