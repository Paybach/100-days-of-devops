# Day 066: Configuration

## Goal

Understand **Configuration** and complete this practical task: **Use ConfigMaps and Secrets**

Your evidence for today is: **Config manifests**
...
2. Complete today's task: **Use ConfigMaps and Secrets**
3. Add your **Config manifests** to this folder, or link to it under Artifact / Evidence.
...
- [ ] I marked Day 066 complete in [PROGRESS.md](../../PROGRESS.md).
...
Continue with [Day 067: Probes](../day-067-probes/README.md).
