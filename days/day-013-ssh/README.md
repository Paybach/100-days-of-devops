...
Understand **SSH** and complete this practical task: **Create a key pair and document secure remote access**

Your evidence for today is: **SSH guide**
...
2. Complete today's task: **Create a key pair and document secure remote access**
3. Add your **SSH guide** to this folder, or link to it under Artifact / Evidence.
...
Continue with [Day 014: Git essentials](../day-014-git-essentials/README.md).
