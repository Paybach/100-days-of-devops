# Day 060: Cloud capstone

## Goal

Understand **Cloud capstone** and complete this practical task: **Document and provision a small cloud architecture**

Your evidence for today is: **Cloud project**

## Research Questions

- What problem does Cloud capstone solve?
...
2. Complete today's task: **Document and provision a small cloud architecture**
3. Add your **Cloud project** to this folder, or link to it under Artifact / Evidence.
...
- [ ] I marked Day 060 complete in [PROGRESS.md](../../PROGRESS.md).
...
Continue with [Day 061: Kubernetes architecture](../day-061-kubernetes-architecture/README.md).
