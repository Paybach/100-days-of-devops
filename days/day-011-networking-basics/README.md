# Day 011: Networking basics

## Goal

Understand **Networking basics** and complete this practical task: **Inspect IP addresses, ports, routes, and DNS**

Your evidence for today is: **Networking cheat sheet**

## Research Questions

- What problem does Networking basics solve?
...
2. Complete today's task: **Inspect IP addresses, ports, routes, and DNS**
3. Add your **Networking cheat sheet** to this folder, or link to it under Artifact / Evidence.
...
Continue with [Day 012: HTTP and HTTPS](../day-012-http-and-https/README.md).
