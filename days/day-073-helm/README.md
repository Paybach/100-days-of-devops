...
Understand **Helm** and complete this practical task: **Package the demo app as a Helm chart**

Your evidence for today is: **Helm chart**
...
2. Complete today's task: **Package the demo app as a Helm chart**
3. Add your **Helm chart** to this folder, or link to it under Artifact / Evidence.
...
Continue with [Day 074: Rollouts](../day-074-rollouts/README.md).
