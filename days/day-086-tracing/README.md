...
Understand **Tracing** and complete this practical task: **Trace a request across components**

Your evidence for today is: **Trace notes**
...
2. Complete today's task: **Trace a request across components**
3. Add your **Trace notes** to this folder, or link to it under Artifact / Evidence.
...
Continue with [Day 087: Incident response](../day-087-incident-response/README.md).
