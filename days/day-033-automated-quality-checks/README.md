# Day 033: Automated quality checks

## Goal

Understand **Automated quality checks** and complete this practical task: **Add linting or tests to CI**

Your evidence for today is: **Quality workflow**

## Research Questions

- What problem does Automated quality checks solve?
...
2. Complete today's task: **Add linting or tests to CI**
3. Add your **Quality workflow** to this folder, or link to it under Artifact / Evidence.
...
Continue with [Day 034: Build automation](../day-034-build-automation/README.md).
