...
Understand **CI concepts** and complete this practical task: **Diagram a build, test, and release pipeline**

Your evidence for today is: **Pipeline diagram**

## Research Questions

- What problem does CI concepts solve?
...
2. Complete today's task: **Diagram a build, test, and release pipeline**
3. Add your **Pipeline diagram** to this folder, or link to it under Artifact / Evidence.
...
Continue with [Day 032: GitHub Actions](../day-032-github-actions/README.md).
