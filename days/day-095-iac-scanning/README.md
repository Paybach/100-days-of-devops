# Day 095: IaC scanning

## Goal

Understand **IaC scanning** and complete this practical task: **Scan infrastructure configuration**

Your evidence for today is: **IaC findings**

## Research Questions

- What problem does IaC scanning solve?
...
2. Complete today's task: **Scan infrastructure configuration**
3. Add your **IaC findings** to this folder, or link to it under Artifact / Evidence.
...
Continue with [Day 096: Backups](../day-096-backups/README.md).
