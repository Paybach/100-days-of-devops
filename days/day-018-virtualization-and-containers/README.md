# Day 018: Virtualization and containers

## Goal

Understand **Virtualization and containers** and complete this practical task: **Compare VMs and containers for one use case**

Your evidence for today is: **Decision note**

## Research Questions

- What problem does Virtualization and containers solve?
...
2. Complete today's task: **Compare VMs and containers for one use case**
3. Add your **Decision note** to this folder, or link to it under Artifact / Evidence.
...
Continue with [Day 019: Configuration management](../day-019-configuration-management/README.md).
