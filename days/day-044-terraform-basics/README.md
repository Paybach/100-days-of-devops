# Day 044: Terraform basics

## Goal

Understand **Terraform basics** and complete this practical task: **Install Terraform and explore HCL**

Your evidence for today is: **First config**

## Research Questions

- What problem does Terraform basics solve?
...
2. Complete today's task: **Install Terraform and explore HCL**
3. Add your **First config** to this folder, or link to it under Artifact / Evidence.
...
Continue with [Day 045: Terraform lifecycle](../day-045-terraform-lifecycle/README.md).
