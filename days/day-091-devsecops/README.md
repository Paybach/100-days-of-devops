...
Understand **DevSecOps** and complete this practical task: **Map security checks across the delivery pipeline**

Your evidence for today is: **Security pipeline**
...
2. Complete today's task: **Map security checks across the delivery pipeline**
3. Add your **Security pipeline** to this folder, or link to it under Artifact / Evidence.
...
Continue with [Day 092: Dependency scanning](../day-092-dependency-scanning/README.md).
