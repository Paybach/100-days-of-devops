...
Understand **Firewalls** and complete this practical task: **Define ingress and egress rules for an app**

Your evidence for today is: **Rule table**

## Research Questions

- What problem does Firewalls solve?
...
2. Complete today's task: **Define ingress and egress rules for an app**
3. Add your **Rule table** to this folder, or link to it under Artifact / Evidence.
...
Continue with [Day 054: Compute](../day-054-compute/README.md).
