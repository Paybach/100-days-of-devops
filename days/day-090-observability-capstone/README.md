# Day 090: Observability capstone

## Goal

Understand **Observability capstone** and complete this practical task: **Add an observability plan to the demo app**

Your evidence for today is: **Observability pack**

## Research Questions

- What problem does Observability capstone solve?
...
- Related milestone: [Production-ready capstone](../../projects/project-05-production-ready-capstone/README.md)
...
2. Complete today's task: **Add an observability plan to the demo app**
3. Add your **Observability pack** to this folder, or link to it under Artifact / Evidence.
...
- [ ] I marked Day 090 complete in [PROGRESS.md](../../PROGRESS.md).
...
Continue with [Day 091: DevSecOps](../day-091-devsecops/README.md).
