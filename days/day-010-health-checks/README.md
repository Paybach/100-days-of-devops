# Day 010: Health checks

## Goal

Understand **Health checks** and complete this practical task: **Check disk, memory, and a web endpoint**

Your evidence for today is: **Health-check script**

## Research Questions

- What problem does Health checks solve?
...
2. Complete today's task: **Check disk, memory, and a web endpoint**
3. Add your **Health-check script** to this folder, or link to it under Artifact / Evidence.
...
- [ ] I marked Day 010 complete in [PROGRESS.md](../../PROGRESS.md).
...
Continue with [Day 011: Networking basics](../day-011-networking-basics/README.md).
