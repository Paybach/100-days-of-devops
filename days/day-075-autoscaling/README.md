...
Understand **Autoscaling** and complete this practical task: **Configure or model horizontal pod autoscaling**

Your evidence for today is: **HPA manifest**
...
2. Complete today's task: **Configure or model horizontal pod autoscaling**
3. Add your **HPA manifest** to this folder, or link to it under Artifact / Evidence.
...
- [ ] I marked Day 075 complete in [PROGRESS.md](../../PROGRESS.md).
...
Continue with [Day 076: GitOps](../day-076-gitops/README.md).
