# Day 041: Cloud fundamentals

## Goal

Understand **Cloud fundamentals** and complete this practical task: **Compare IaaS, PaaS, and SaaS examples**

Your evidence for today is: **Cloud comparison**
...
2. Complete today's task: **Compare IaaS, PaaS, and SaaS examples**
3. Add your **Cloud comparison** to this folder, or link to it under Artifact / Evidence.
...
Continue with [Day 042: IAM](../day-042-iam/README.md).
