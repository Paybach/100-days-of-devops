# Day 008: Packages and environment

## Goal

Understand **Packages and environment** and complete this practical task: **Install a package and use environment variables**

Your evidence for today is: **Setup script**

## Research Questions

- What problem does Packages and environment solve?
...
2. Complete today's task: **Install a package and use environment variables**
3. Add your **Setup script** to this folder, or link to it under Artifact / Evidence.
...
Continue with [Day 009: Bash scripting](../day-009-bash-scripting/README.md).
