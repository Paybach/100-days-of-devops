...
Understand **GitOps** and complete this practical task: **Explain pull-based delivery and repository structure**

Your evidence for today is: **GitOps design**
...
2. Complete today's task: **Explain pull-based delivery and repository structure**
3. Add your **GitOps design** to this folder, or link to it under Artifact / Evidence.
...
Continue with [Day 077: Argo CD](../day-077-argo-cd/README.md).
