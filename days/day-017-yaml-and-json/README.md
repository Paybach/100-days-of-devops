# Day 017: YAML and JSON

## Goal

Understand **YAML and JSON** and complete this practical task: **Write and validate sample configuration files**

Your evidence for today is: **Config examples**

## Research Questions

- What problem does YAML and JSON solve?
...
2. Complete today's task: **Write and validate sample configuration files**
3. Add your **Config examples** to this folder, or link to it under Artifact / Evidence.
...
Continue with [Day 018: Virtualization and containers](../day-018-virtualization-and-containers/README.md).
