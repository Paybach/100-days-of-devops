# Day 094: Secret scanning

## Goal

Understand **Secret scanning** and complete this practical task: **Detect and prevent committed secrets**

Your evidence for today is: **Prevention notes**

## Research Questions

- What problem does Secret scanning solve?
...
2. Complete today's task: **Detect and prevent committed secrets**
3. Add your **Prevention notes** to this folder, or link to it under Artifact / Evidence.
...
- [ ] I marked Day 094 complete in [PROGRESS.md](../../PROGRESS.md).
...
Continue with [Day 095: IaC scanning](../day-095-iac-scanning/README.md).
