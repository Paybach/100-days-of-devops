# Day 015: Pull requests

## Goal

Understand **Pull requests** and complete this practical task: **Resolve a merge conflict in a practice branch**

Your evidence for today is: **Conflict-resolution notes**

## Research Questions

- What problem does Pull requests solve?
...
2. Complete today's task: **Resolve a merge conflict in a practice branch**
3. Add your **Conflict-resolution notes** to this folder, or link to it under Artifact / Evidence.
...
Continue with [Day 016: GitHub workflow](../day-016-github-workflow/README.md).
