...
Understand **Compute** and complete this practical task: **Launch or model a small compute workload**

Your evidence for today is: **Compute notes**
...
2. Complete today's task: **Launch or model a small compute workload**
3. Add your **Compute notes** to this folder, or link to it under Artifact / Evidence.
...
Continue with [Day 055: Object storage](../day-055-object-storage/README.md).
