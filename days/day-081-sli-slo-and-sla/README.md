# Day 081: SLI, SLO, and SLA

## Goal

Understand **SLI, SLO, and SLA** and complete this practical task: **Define reliability targets for the demo app**

Your evidence for today is: **Reliability targets**

## Research Questions

- What problem does SLI, SLO, and SLA solve?
...
2. Complete today's task: **Define reliability targets for the demo app**
3. Add your **Reliability targets** to this folder, or link to it under Artifact / Evidence.
...
Continue with [Day 082: Logging](../day-082-logging/README.md).
