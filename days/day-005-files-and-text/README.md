# Day 005: Files and text

## Goal

Understand **Files and text** and complete this practical task: **Practice `cat`, `less`, `grep`, `head`, and `tail`**

Your evidence for today is: **Text-processing examples**

## Research Questions

- What problem does Files and text solve?
...
2. Complete today's task: **Practice `cat`, `less`, `grep`, `head`, and `tail`**
3. Add your **Text-processing examples** to this folder, or link to it under Artifact / Evidence.
...
- [ ] I marked Day 005 complete in [PROGRESS.md](../../PROGRESS.md).
...
Continue with [Day 006: Users and permissions](../day-006-users-and-permissions/README.md).
