...
Understand **Pods** and complete this practical task: **Run and inspect a pod**

Your evidence for today is: **Pod manifest**

## Research Questions

- What problem does Pods solve?
...
2. Complete today's task: **Run and inspect a pod**
3. Add your **Pod manifest** to this folder, or link to it under Artifact / Evidence.
...
- [ ] I marked Day 063 complete in [PROGRESS.md](../../PROGRESS.md).
...
Continue with [Day 064: Deployments](../day-064-deployments/README.md).
